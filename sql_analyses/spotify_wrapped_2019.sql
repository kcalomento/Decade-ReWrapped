-- Create the table for 2019 data
CREATE TABLE spotify_history_2019 (
    ts TIMESTAMP,
    ms_played INT,
...
COPY spotify_history_2019
FROM 'C:/Users/kcalo/Desktop/Bootcamp/My-Spotify-Extended-History/cleaned_data/csv/spotify_2019_fixed.csv'
WITH (FORMAT csv, HEADER, DELIMITER ',');

---

-- Check the total number of records
SELECT COUNT(*) FROM spotify_history_2019;

-- Preview the first 10 rows
SELECT * FROM spotify_history_2019 LIMIT 10;

-- Check for missing data
SELECT COUNT(*) 
FROM spotify_history_2019 
