-- Create the table for 2020 data
CREATE TABLE spotify_history_2020 (
    ts TIMESTAMP,
    ms_played INT,
...
COPY spotify_history_2020
FROM 'C:/Users/kcalo/Desktop/Bootcamp/My-Spotify-Extended-History/cleaned_data/csv/spotify_2020_fixed.csv'
WITH (FORMAT csv, HEADER, DELIMITER ',');

---

-- Check the total number of records
SELECT COUNT(*) FROM spotify_history_2020;

-- Preview the first 10 rows
SELECT * FROM spotify_history_2020 LIMIT 10;
...
SELECT master_metadata_track_name, master_metadata_album_artist_name, COUNT(*) AS play_count
FROM spotify_history_2020
GROUP BY master_metadata_track_name, master_metadata_album_artist_name
ORDER BY play_count DESC, master_metadata_track_name ASC
LIMIT 100;
