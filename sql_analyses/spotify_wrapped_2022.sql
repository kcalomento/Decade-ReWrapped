-- Create the table for 2022 data
CREATE TABLE spotify_history_2022 (
    ts TIMESTAMP,
    ms_played INT,
...
COPY spotify_history_2022
FROM 'C:/Users/kcalo/Desktop/Bootcamp/My-Spotify-Extended-History/cleaned_data/csv/spotify_2022_fixed.csv'
WITH (FORMAT csv, HEADER, DELIMITER ',');

---

-- Check the total number of records
SELECT COUNT(*) FROM spotify_history_2022;

-- Preview the first 10 rows
SELECT * FROM spotify_history_2022 LIMIT 10;

-- Check for missing data
SELECT COUNT(*) 
FROM spotify_history_2022 
