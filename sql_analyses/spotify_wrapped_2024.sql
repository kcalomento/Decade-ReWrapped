-- Create the table for 2024 data
CREATE TABLE spotify_history_2024 (
    ts TIMESTAMP,
    ms_played INT,
...
COPY spotify_history_2024
FROM 'C:/Users/kcalo/Desktop/Bootcamp/My-Spotify-Extended-History/cleaned_data/csv/spotify_2024_fixed.csv'
WITH (FORMAT csv, HEADER, DELIMITER ',');

---

-- Check the total number of records
SELECT COUNT(*) FROM spotify_history_2024;

-- Preview the first 10 rows
SELECT * FROM spotify_history_2024 LIMIT 10;

-- Check for missing data
SELECT COUNT(*) 
FROM spotify_history_2024 
